...
HBase is a hadoop database that is used for storing and retrieving data with a random access. HBase architecture is designed to run on cluster of computers rather than a single machine \cite{coprocessor:detail}. HBase is designed to scale horizontally by adding more machines to the cluster. 
